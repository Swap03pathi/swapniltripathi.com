...
description:
  ...
  },
  {
    ...
    name: 'Ranking & Pricing Analysis',
    highlight:
      'Statistical experiments exploring what drives OTA search ranking — rigorous, and ultimately inconclusive.',
    description:
      'Ran ranking-analysis experiments on scraped OTA listing data, using p-values, coefficients, and correlations to explore which variables influenced hotel search ranking.\n\nAlso evaluated discount strategies across platforms to check for pricing parity and price masking.\n\nThe experiments did not lead to meaningful conclusions — but they were my first real exposure to exploratory analytics on messy, real-world data.',
    tools: [
      { name: 'Python', logoUrl: 'https://cdn.simpleicons.org/python/3776AB', homepageUrl: 'https://python.org' },
      { name: 'Excel', logoUrl: 'https://cdn.simpleicons.org/microsoftexcel/217346', homepageUrl: 'https://microsoft.com/excel' },
    ],
